...
$.ajax({
    ...
    success: function (data) {
        ...
        for (var i = 0; i < data.results.length; i++) {
            ...
            tarjeta += '<a href="#" data-toggle="modal" data-target="#exampleModal"><img class="poster card-img-top" src="img/'+ data.results[i].name.replace(' ','').tolowercase() +'.png" alt="'+ data.results[i].name.replace(' ','') +'"></a>';
